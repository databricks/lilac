...
A concept in Lilac is the algorithmic version of a concept we have in our head.

Often time human concepts are fuzzy, hard to codify into a computer, or are simply "you know it when
you see it".
