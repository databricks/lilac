...
#   git clone --depth 1 https://github.com/tensorflow/io.git --branch v0.32.0 "$TENSORFLOW_IO_DIRNAME"
...
#   # python -m pip install --force-reinstall --no-deps dist/tensorflow_io*
